...
letters=[ "a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z","ae","oe","ue","sch","one", "two", "three", "four" , "five"]
...
def gen_keypoints_for_frames(frames, save_path):
    ...
    pose_kps, pose_confs = get_holistic_keypoints(frames, holistic=mp_holistic.Holistic(static_image_mode=False, model_complexity=2)
)
...
if __name__ == "__main__":
    ...
    for l in letters:
        ...
        DIR =".\\fingerspelling_dataset\\I6_Gestures\\video\\test\\"
        SAVE_DIR = ".\\fingerspelling_dataset\\I6_Gestures\\pkl_poses\\test\\"

        dir = os.path.join(DIR, l)
        save_dir = os.path.join(SAVE_DIR, l)
        ...
        for file in os.listdir(dir):
                ...
                save_paths.append(os.path.join(save_dir, file.replace(".mpg", "")))
...
##############################
#video_path= "./fingerspelling_dataset/I6_Gestures/video/test/a/19_1_2_cam2.mpg"
#save_path = "./fingerspelling_dataset/I6_Gestures/sample"

#frames = load_frames_from_video(video_path)

#get_holistic_keypoints(frames)
